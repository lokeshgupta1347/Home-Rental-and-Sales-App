...
const Footer = () => {
    return (
        <footer className='pt-16 xl:pt-20 w-full text-gary-500 bg-[#fffbee]'>
        <div className='max-padd-container'>
          ...
          <Link to={'/'}>
             <img src={assets.logoImg} alt="logo" className={`h-11`} />
                    ...
                    <p className='text-sm'>
                       Experience modern living through well-presented properties ,professional support,and toughtfully designed spaces.
                    </p>
