...
const MyBooking = () => {
  ...
  return (
    <div className=' max-padd-conatiner bg-gradient-to-r from-[#fffbee] to white py-16 pt-28'>
      ...
      <div className='flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 border-t border-gray-300 pt-3'>
        <div className='flex gap-2 gap-x-4 flex-wrap'>
            ...
            <div className='flex items-center gap-x-2'>
                ...
                <p className='text-gray-400 text-xs break-all'>{new Date(booking.checkInDate).toDateString()}</p>
            </div>
            <div className='flex items-center gap-x-2'>
                <h5 className="medium-14">Check-Out:</h5>
                <p className='text-gray-400 text-xs break-all'>{new Date(booking.checkOutDate).toDateString()}</p>
            </div>
        </div>
