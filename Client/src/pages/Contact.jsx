...
const Contact = () => {
  return (
    <div className='bg-gradient-to-r form-[#fffbee] to-white py-16 pt-28'>
       <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-secondary hover:underline">hello@prebuiltui.com</a>
            </p>
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <textarea rows="4" className="w-full mt-2 p-2  border border-slate-300 rounded-lg resize-none outline-none focus:ring-2 focus-within:ring-indigo-400 bg-secondary/10  transition-all" placeholder="Enter your message" required></textarea>
